...
def main():
  ...
  plistpath = scriptpath + "/resources/Fourses-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Fourses-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Fourses-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Fourses-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Fourses-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Fourses.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Fourses.iss",inplace=1):
