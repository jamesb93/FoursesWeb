...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Fourses Demo Installer\n"
      else:
        line="OutputBaseFilename=Fourses Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Fourses Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Fourses installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Fourses Demo installer\n"
     else:
       line="SetupWindowTitle=Fourses installer\n"
